                ...
                {isEditingWorkflow ? (
                  <div className="flex items-center gap-1.5">
                    <input
                      ...
                      autoFocus
                    />
                    <button onClick={handleUpdateWorkflow} className="text-xs text-emerald-400 hover:text-emerald-300 font-medium px-1">Save</button>
                    <button onClick={() => setIsEditingWorkflow(false)} className="text-xs text-slate-400 hover:text-slate-300 px-1">Cancel</button>
                  </div>
                ) : (
                  <>
                    <span className="text-xs text-slate-400 font-medium">Active: <span className="text-slate-200">{activeWorkflow.name}</span></span>
                    <button 
                      onClick={() => {
